...
class EventFolds:
    def __init__(
        ...
        print(f"Creating EventFolds with {len(nomes_instancias)} instances")
        
        # Log each instance being loaded
        for nome_instancia in nomes_instancias_evento:
            print(f"Loading instance: {nome_instancia}")
            self.instancias[nome_instancia] = self.carregue_instancia(
                nome_instancia, experiment.event_name, self.path
            )
...
class Experiment:
    ...
    def folds(self):
        ...
        print(f"Instance names: {nomes_instancias}")
        print(f"Folds instances: {folds_instancias}")
